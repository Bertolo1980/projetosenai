...
class CadastroGenerico {
    ...
    public function cadastrar($tabela, $dados) {
        if ($this->verificarExistencia($tabela, 'cpf', $dados['cpf']) || $this->verificarExistencia($tabela, 'email', $dados['email'])) {
            return "CPF ou e-mail já existem. Cadastro não realizado.";
        }
